  ...
  return (
    ...
    >
        ...
        <Box>
          <Flex justify="space-between" mb={1} align="center">
            <HStack gap={1}>
              ...
              <Text fontSize="2xs" fontWeight="bold" color="nvr.text.secondary">
                CONSUMO DE CPU
              </Text>
            </HStack>
            <Text
      ...
      >
        <Text>
          Iniciado:{" "}
          <Text as="span" fontWeight="semibold" color="nvr.text.primary">
            {stream.start}
          </Text>
        </Text>
        <Text>
      ...
      <Box>
        ...
        >
          <Text fontSize="2xs" fontWeight="semibold" color="nvr.text.secondary">
