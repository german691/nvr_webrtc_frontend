 ...
 * Permite monitorear CPU, Memoria, URL RTSP y comandos activos en el host Edge,
 * eliminando toda lógica interna mediante hooks especializados e inlining de estilos.
 */
    ...
    <Portal>
      ...
      >
        ...
        >
          ...
          >
            <HStack gap={3}>
              <Center p={2} borderRadius="xl" bg="nvr.brand.activeBg" color="nvr.brand.primaryText">
                <Activity size={20} />
              </Center>
          ...
          <Box flex="1" overflowY="auto" p={3} bg="nvr.bg.muted">
            ...
            {!isDebuggingLoading && debugError && (
              <Center py={12} flexDirection="column" gap={3} px={4}>
                <Text color="nvr.brand.danger" fontWeight="medium" fontSize="sm" textAlign="center">
                  {debugError}
                </Text>
            ...
            {!isDebuggingLoading && !debugError && debugStreams.length === 0 && (
              <Center py={16} flexDirection="column" gap={4} px={6}>
                <Center p={4} borderRadius="full" bg="nvr.bg.muted" color="nvr.text.secondary">
                  <Terminal size={32} />
                </Center>
                <VStack gap={1} align="center">
                  <Text fontWeight="semibold" fontSize="sm" color="nvr.text.primary">
                    No hay transmisiones FFmpeg activas
                  </Text>
                  <Text fontSize="xs" color="nvr.text.secondary" textAlign="center" maxW="sm">
